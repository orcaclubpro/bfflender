...
const WhyBrokersSwitch = React.memo(({ isVisible, trackInteraction }: { 
  isVisible: boolean; 
...
WhyBrokersSwitch.displayName = 'WhyBrokersSwitch';
        ...
        <div className="min-h-screen flex flex-col justify-center py-20">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}>
              ...
              {/* Why Brokers Switch */}
              <WhyBrokersSwitch isVisible={isVisible} trackInteraction={trackInteraction} />
