...
import { ArrowRight, TrendingUp, CheckCircle, Award, Clock, DollarSign, Zap, Users, Shield, Target, X } from 'lucide-react';
...
const Hero = () => {
  ...
  const handleUrgencyDismiss = (e: React.MouseEvent) => {
    e.stopPropagation();
  ...
  return (
    ...
    >
      ...
      {/* Urgency Banner - Positioned below header */}
      {showUrgency && !urgencyDismissed && (
        <div 
