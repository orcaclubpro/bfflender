          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6">
              ...
              <p className="text-gray-700">
                94.2% of business owners who take our challenge see improved performance with BFFLender
              </p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-700">Average revenue improvement for business owners who switch to BFFLender</p>
            </Card>
