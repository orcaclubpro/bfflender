          ...
          <div className="max-w-7xl mx-auto content-spacing">
            <div className="text-center mb-20 animate-fade-in-up">
              ...
              <p className="text-body-lg sm:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                We're so confident in our business model that we'll prove it with hard numbers. If we can't beat your
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
              <Card className="card-feature text-center group border-emerald-100 hover:border-emerald-300 transition-all duration-300">
                <CardHeader className="pb-6">
                  ...
                  <CardTitle className="text-2xl text-slate-900">Business Owners Challenged</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <div className="mb-20">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Card className="card-elevated text-center group border-amber-100 hover:border-amber-300 hover:shadow-amber-100/50 transition-all duration-300">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-slate-600 leading-relaxed">
                      Detailed comparison with our proven business model and optimization recommendations
                    </p>
            ...
            <div className="bg-gradient-to-r from-amber-500 to-amber-600 rounded-3xl p-10 sm:p-12 lg:p-16 text-white text-center shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl sm:text-2xl mb-12 text-amber-100 font-light max-w-3xl mx-auto">
                  Join the 94.2% of business owners who discovered the BFFLender advantage and transformed their business
                </p>
