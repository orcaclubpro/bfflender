      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Real results from real business owners who took the challenge</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6">
              <CardHeader>
                <CardTitle className="text-lg">The Overwhelmed Solo Business Owner</CardTitle>
              </CardHeader>
              <CardContent>
